...
@section('content')
    <div class="card">
        <div class="card-header">
            <a href="{{ url('siswa/add') }}" class="btn btn-primary"> <i class="fas fa-plus"></i> Tambah Data</a>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>{{ $item->nisn }}</td>
                            <td>{{ $item->rombongan->rombongan }}</td>
                            <td>{{ $item->jeniskelamin }}</td>
                            <td class="text-center">
                                <a href="{{ url('siswa/edit/' . $item->id) }}" class="btn btn-xs btn-warning"
