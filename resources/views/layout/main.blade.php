...
<head>
    ...
    <title>@yield('title') - Eligible</title>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ url('ganti_setting') }}"
                                class="nav-link {{ request()->is('ganti_setting') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('siswa/rombonganbelajar') }}"
                                class="nav-link {{ request()->is('siswa/rombonganbelajar') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-book"></i>
                                <p>
                                    Rombongan Belajar
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('siswa/index') }}"
                                class="nav-link {{ request()->is('siswa/index') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-book"></i>
                                <p>
                                    Data Siswa
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('hasilakhir') }}"
                                class="nav-link {{ request()->is('hasilakhir') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-book"></i>
                                <p>
                                    Hasil Akhir
                                </p>
